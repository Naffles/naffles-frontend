                    ...
                    <div className="w-7/12">
                      <div className="mt-24">
                        ...
                        <p className="text-body-lg text-nafl-charcoal-800 py-4">
                          Win NFTs raffled by our community of trusted degens, where profits
                          can be verifiably-fair and fun for everyone. Please degen
                          responsibly!
                        </p>
                        <Button
                          size="base"
                          ...
                          label="Explore"
                          leftIcon={
                            <MagnifyingIcon size="sm" colour="black" />
                          }
                        >
                          Explore
                        </Button>
                    ...
                    <div className="w-5/12">
                      <div className="relative flex">
                        <Image
                          ...
                          height={350}
                          objectFit="cover"
                          className="absolute top-0 left-4" style={{ zIndex: 2 }}
                        ...
                        <Image
                          ...
                          height={290}
                          objectFit="cover"
                          className="absolute top-8 left-56" style={{ zIndex: 1 }}
                        />
                      </div>
                      <div className="mt-[26rem] flex flex-col ml-[10rem]">
                        ...
                        <div className="flex-row flex justify-between pt-3 w-72 mt-3 px-1">
                          <div className="flex-1 justify-center">
                            <h4 className="text-lg font-semibold text-nafl-charcoal-500">Floor price</h4>
                            <div className="flex">
                              <Image src="/static/eth-logo.png" alt="nafl-coin" width={20} height={20} style={{objectFit: 'contain'}}/>
                              <h2 className="text-3xl font-semibold text-nafl-charcoal-500 text-right">1.01</h2>
                            </div>
                            <Typography className="text-sm font-semibold ml-5" color="accent-green">($3,542 USD)</Typography>
                          </div>
                          <div className="h-[7rem] bg-nafl-charcoal-300 w-0.5 opacity-25 mx-10"></div>
                          <div className="flex-1 ">
                            <div className="flex-1 justify-center">
                              <h4 className="text-lg font-semibold text-nafl-charcoal-500">tickets from</h4>
                              <div className="flex">
                                <Image src="/static/eth-logo.png" alt="nafl-coin" width={20} height={20} style={{objectFit: 'contain'}}/>
                                <h2 className="text-3xl font-semibold text-nafl-charcoal-500 text-right">0.01</h2>
                              </div>
                              <Typography className="text-sm font-semibold ml-5" color="accent-green">($16 USD)</Typography>
                            </div>
                          </div>
                        </div>
                      </div>
