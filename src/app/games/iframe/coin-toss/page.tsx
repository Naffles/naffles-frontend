...
import { CoinTossGame } from '@components/GameSection/Games/CoinTossGame';
import { useSearchParams } from 'next/navigation';
import { gameIFrameComm, GameMessage, BetConfirmationData } from '@services/gameIFrameComm';

export default function CoinTossIFramePage() {
  ...
  useEffect(() => {
    ...
    unsubscribers.push(
      gameIFrameComm.onMessage('PARENT_READY', (message: GameMessage) => {
        ...
        gameIFrameComm.notifyGameReady('coin-toss', gameConfig);
      })
    );
