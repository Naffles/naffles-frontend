        ...
        <div className="flex flex-col items-start h-auto">
          <div className="flex flex-row">
            ...
            <div className="flex flex-col m-5">
              ...
              <input type="text" name="username" placeholder="Username" className="border border-black p-2 w-[300px]" />
              <label htmlFor="email" className="text-nafl-white tex-sm mt-5">
                <h5 className="text-nafl-sponge-500 text-sm">Email</h5>
              </label>
              <input type="text" name="email" placeholder="email" className="border border-black p-2 w-[300px]" />
            </div>
          </div>
          <div className="flex flex-col w-full mt-3 items-center">
            ...
            <div className="flex flex-col items-center justify-between w-full">
              ...
              <div className="flex flex-row items-center justify-between w-[300px] mt-1">
                <input type="text" name="wallet" placeholder="0xb794f5ea0...ba74279579268" className="border border-black p-2 w-[300px]" disabled/>
                <DeleteIcon size="sm" colour="yellow" className="mt-[2px] ml-3 cursor-pointer"/>
              </div>
              <div className="flex flex-row items-center justify-between w-[300px] mt-1">
                <input type="text" name="wallet" placeholder="0xb794f5ea0...ba74279579268" className="border border-black p-2 w-[300px]" disabled/>
                <DeleteIcon size="sm" colour="yellow" className="mt-[2px] ml-3 cursor-pointer"/>
            ...
            <div className="flex flex-col items-center w-full h-full">
              ...
              <div className="flex flex-col items-center justify-center w-1/2">
                <div className="flex flex-col items-center justify-center w-full mt-3">
                  ...
                  <button className="bg-nafl-sponge-500 rounded-md w-40 mt-[25px]" onClick={() => setOpenModal(true)}>
          ...
          <div className="w-2/3 h-full bg-nafl-charcoal-500 mt-[60px]">
            <ul className="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-nafl-sponge-500 dark:border-gray-700 dark:text-gray-400">
              {
                tabsState.map((tab, index) => {
                  const activeString = "inline-block text-lg p-4 text-nafl-charcoal-800 bg-nafl-sponge-500 rounded-t-lg active dark:bg-gray-800 dark:text-blue-500";
                  const inactiveString = "inline-block text-lg p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 text-nafl-charcoal-100";
                  return (
                    <li className="me-2" key={index} onClick={() => handleOnTabClick(tab.key)}>
            ...
            </ul>
            {
              liveNaffles.state && (
                <div className="flex flex-col w-full h-full">
                  <h1 className="text-5xl text-nafl-white mt-5 mb-5">LIVE NAFFLES</h1>
                  ...
                  <div className="overflow-x-auto h-auto">
                    <Table className="bg-nafle-charcoal-800">
                      ...
                      <Table.Body className="divide-y border-none">
                        ...
                        <Table.Row className="bg-nafle-charcoal-600 dark:border-gray-700 dark:bg-gray-800 text-nafl-sponge-100 border-none">
                          <Table.Cell className="whitespace-nowrap font-medium dark:text-white">Magic Mouse 2</Table.Cell>
            ...
            }
            {
              affiliateRewards.state && (
                <div className="flex flex-col w-full h-full">
                  <h1 className="text-5xl text-nafl-white mt-5">AFFILIATE REWARDS</h1>
