    ...
    <div className="flex flex-col items-center w-full h-screen pt-28 px-8 overflow-hidden mt-[80px]">
      ...
      <div className="w-full max-w-[900px] max-h-[1200px] h-5/6 mt-4 text-nafl-white overflow-auto font-face-roboto text-body-base font-bold">
        ...
        <div className="flex flex-row">
          <p>4.1</p>
          <p className="ml-4">
          To access or use our Services, you must register an account via our
        ...
        <div className="flex flex-row">
          <p>4.2</p>
          <p className="ml-4">By registering an Account via our Website, you represent and warrant
            ...
            Website is true, correct, and complete.</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>4.3</p>
          <p className="ml-4">We are under no obligation to open an Account for you and our website
        ...
        <div className="flex flex-row">
          <p>4.4</p>
          <p className="ml-4">Upon receipt of your application to open an Account, we may contact
            ...
            failure to provide documents or information on our request.</p>
          </div>
        <br />
        <div className="flex flex-row">
          <p>4.5</p>
          <p className="ml-4">To the maximum extent allowed by law, we accept no liability for any
          losses suffered by you with regards to losing access to your account,
          its associated funds, or any of the information stored by Naffles. </p>
        <br />
        </div>
        <div className="flex flex-row">
          <p>4.6</p>
        ...
        <div className="flex flex-row">
          <p>5.1</p>
          <p className="ml-4">Accounts could use several currencies; in this case all Account
        ...
        <div className="flex flex-row">
          <p>5.2</p>
          <p className="ml-4">We do not give credit for the use of the Services.</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>5.3</p>
        ...
        <div className="flex flex-row">
          <p>5.4</p>
          <p className="ml-4">We reserve the right to close or suspend any Account without prior
          notice and return all funds. contractual obligations already matured
          will however be honoured. </p>
        </div>
        <br />
        ...
        <div className="flex flex-row">
          <p>5.7</p>
          <p className="ml-4">If, for any reason, your Account goes overdrawn, you shall be in debt
          to us for the amount overdrawn.</p>
        </div>
        
        <br />
        <div className="flex flex-row">
          <p>5.8</p>
          <p className="ml-4">You must inform us as soon as you become aware of any errors with
          respect to your Account.</p>
        </div>
        ...
        <div className="flex flex-row">
          <p>5.10</p>
          <p className="ml-4">You cannot transfer, sell, or pledge your Account to another person.
        ...
        <div className="flex flex-row">
          <p>5.11</p>
          <p className="ml-4">Should you wish to close your account with us, please send an email
          from your registered email address to us via the links on the Website.</p>
        </div>
        <br />
        <br />
        ...
        <div className="flex flex-row">
          <p>(a)</p>
          <p className="ml-4">You are over 18, or the legal age at which gambling, or gaming
        ...
        <div className="flex flex-row">
          <p>(c)</p>
          <p className="ml-4">You are a resident in a jurisdiction that allows gambling. You are
          ...
          sole responsibility to ensure that your use of the service is legal.</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>(d)</p>
          <p className="ml-4">You may not use a VPN, proxy or similar services or devices that mask
          or manipulate the identification of your real location.</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>(e)</p>
          <p className="ml-4">You are the authorized user of the payment method you use.</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>(f)</p>
          <p className="ml-4">You must make all payments to us in good faith and not attempt to
          reverse a payment made or take any action which will cause such payment
          to be reversed by a third party.</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>(g)</p>
          <p className="ml-4">When participating in the Raffles,you may lose your money deposited
          to participate in the Raffles in accordance with these Terms and you
          will be fully responsible for that loss.</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>(h)</p>
          <p className="ml-4">You are not acting on behalf of another party or for any commercial
        ...
        <div className="flex flex-row">
          <p>(i)</p>
          <p className="ml-4">You must not either attempt to manipulate any market or element
          within the Service in bad faith nor in a manner that adversely affects
          the integrity of the Service or us.</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>(j)</p>
        ...
        <div className="flex flex-row">
          <p>(c)</p>
          <p className="ml-4">if you are a resident of one of the Restricted Countries, or
          accessing the Website from one of the Restricted Countries: Austria, France and its territories, Germany, Netherlands and its
        territories, Spain, Union of Comoros, United Kingdom, USA and its
        territories, All FATAF Blacklisted countries, and any other
        jurisdictions deemed prohibited by Anjouan Offshore Financial Authority.</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>(d)</p>
          <p className="ml-4">if you accessor use the Website for any purpose other than that for
          which we make the Website available; or</p>
        </div>
        <div className="flex flex-row">
          <p>(e)</p>
        ...
        <div className="flex flex-row">
          <p>(f)</p>
          <p className="ml-4">if you accessor use the Website in connection with one or more of the
          Prohibited Activities described in these Terms.</p>
        </div>
        <br />
        <br />
        ...
        <div className="flex flex-row">
          <p>(b)</p>
          <p className="ml-4">you will not use our Services in connection with any of the
          Prohibited Activities;</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>(c)</p>
          <p className="ml-4">you fully understand and have experience with gambling and raffles
          services and the risks associated with gambling activity;</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>(d)</p>
          <p className="ml-4">there is no guarantee against losses of funds you may experience
          while accessing and/or using the Website for raffles, gambling, buying
          or selling purposes;</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>(e)</p>
          <p className="ml-4">you are not entering into transactions that are above your financial
        ...
        <div className="flex flex-row">
          <p>9.1</p>
          <p className="ml-4">If we suspect that you are or receive notification that you are
        ...
        <div className="flex flex-row">
          <p>9.2</p>
          <p className="ml-4">In the event we suspect you are in breach of the provisions of this
          ...
          the matter, including informing the relevant law enforcement agencies.</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>9.3</p>
          <p className="ml-4">If having found that you are currently 18 years or below or were
          under 18 years or below the majority age which applies to you at the
        ...
        <div className="flex flex-row">
          <p>9.4</p>
          <p className="ml-4">This condition also applies to you if you are over the age of 18
        ...
        <div className="flex flex-row">
          ...
          transaction on the respective blockchain network.</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>10.4</p>
          <p className="ml-4">You agree to fully pay any and all payments and charges due to us or
          ...
          the funds held in it.</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>10.5</p>
          <p className="ml-4">Funds originating from criminal and/or illegal and/or unauthorized
          activities must not be deposited with us.</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>10.6</p>
          <p className="ml-4">If you deposit using your credit card, it is recommended that you
          retain a copy of transaction records and a copy of these Terms.</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>10.7</p>
        ...
        <div className="flex flex-row">
          <p>11.1</p>
          <p className="ml-4">You are fully responsible for paying all monies owed to us. You must
        ...
        <div className="flex flex-row">
          <p>11.2</p>
          <p className="ml-4">We reserve the right to use third party electronic payment processors
          and or merchant banks to process payments made by you and you agree to
          be bound by their terms and conditions providing they are made aware to
          you and those terms do not conflict with these Terms.</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>11.3</p>
          <p className="ml-4">All transactions made on our site might be checked to prevent money
        ...
        <div className="flex flex-row">
          <p>13.5</p>
          <p className="ml-4">
            We may in our reasonable discretion accept or reject any entry to our
            Raffles; we also reserve the right to exclude or disqualify persons
        ...
        <div className="flex flex-row">
          <p>13.6</p>
          <p className="ml-4">
            By participating in Raffles, you acknowledge your acceptance of these
            Terms as a pre-condition of your entry. If you do not agree with any of
            these Terms, you must refrain from participating in the Raffles.
          </p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>13.7</p>
          <p className="ml-4">
            All results posted shall be final after 24hours and no queries will
        ...
        <div className="flex flex-row">
          <p>14.1</p>
          <p className="ml-4">
            You acknowledge and agree that the Website and its Services are the
        ...
        <div className="flex flex-row">
          <p>14.2</p>
          <p className="ml-4">
            You acknowledge and agree that Naffles retains all rights, title, and
            interest in and to all copyrights, trademarks, trade secrets, patents,
            and any other proprietary rights in the Website, the software and
            application programming interfaces (APIs) comprising the Website, and
            all content therein. You acknowledge and agree that “Naffles”, their
        ...
        <div className="flex flex-row">
          ...
          <p className="ml-4">
            ...
            Websites accessed through
            <br />
            the Website, or any Third-Party Content posted on, available through,
        ...
        <div className="flex flex-row">
          ...
          <p className="ml-4">
            ...
            your own risk and you should be aware that these Terms and Conditions
            no longer govern your use of and interaction with these Websites and/or
        ...
        <div className="flex flex-row">
          ...
          <p className="ml-4">
            ...
            otherwise terminate these Terms, you will not receive any refunds for
            any purchases that you might make on or through the Website.
          </p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>22.2</p>
          <p className="ml-4">
            You agree that we, in our sole discretion and for any or no reason,
            may terminate these Terms or suspend and/or terminate your use of our
            , or ban your wallet address from using the Website without the
            provision of prior notice. You agree that any suspension or
            termination of your access to the Website may be without prior notice
        ...
        <div className="flex flex-row">
          ...
          <p className="ml-4">
            ...
            law enforcement or regulatory authority, or notifying the harmed party
            of any illegal or unauthorised use of the Website. Without limiting the
        ...
        <div className="flex flex-row">
          <p>22.5</p>
          <p className="ml-4">
            Upon any termination or expiration of these Terms, whether by you or
        ...
        <div className="flex flex-row">
          <p>23.3</p>
          <p className="ml-4">The limitation of liability set out above shall not be applicable in
          case of loss or damages caused by Nafflesor any of its employees by
          intentional misconduct or gross negligence.</p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>23.4</p>
          <p className="ml-4">The Website supports or is integrated with third party services.
          Naffles takes no responsibility for any third-party services and will
          not be liable for any loss or damages caused by such third-party services. </p>
        </div>
        
        <br />
        <div className="flex flex-row">
          <p>23.5</p>
          <p className="ml-4">The Website is provided on an “as is” and “as available” basis
        without any representation or warranty of any kind, whether express or
        implied, to the maximum extent permitted by applicable laws. </p>
        </div>
        <br />
        <div className="flex flex-row">
          <p>23.6</p>
          <p className="ml-4">Naffles disclaims any implied warranties of title, merchantability,
        ...
        <div className="flex flex-row">
          <p>1.</p>
          <p className="ml-4">
            Systematically retrieving data or other content from the Website to
        ...
        <div className="flex flex-row">
          <p>9.</p>
          <p className="ml-4">
            Improperly using our support services or submitting false reports of
            abuse or misconduct;
          </p>
        </div>
        <br />
        ...
        <div className="flex flex-row">
          <p>12.</p>
          <p className="ml-4">
            Attempting to impersonate another user or person or use the username
            of another user;
          </p>
        </div>
        <br />
        ...
        <div className="flex flex-row">
          <p>17.</p>
          <p className="ml-4">
            Attempting to bypass any measures of the Website designed to prevent
        ...
        <div className="flex flex-row">
          <p>24.</p>
          <p className="ml-4">
            Disparaging, tarnishing, or otherwise harming, us and/or the Website,
        ...
        <div className="flex flex-row">
          <p>30.</p>
          <p className="ml-4">
            Using the Website in a manner inconsistent with any applicable laws
            or regulations.
          </p>
        </div>
      </div>
