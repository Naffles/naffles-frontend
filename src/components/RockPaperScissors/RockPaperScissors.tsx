...
export const RockPaperScissors = (props: GameContainer) => {
  ...
  const isVideoHidden = (coinVid: number, handVid: string) => {
    if (coinVid === coin && handVid === winningChoice) return "";
    return "hidden";
  };
  ...
  return (
    <div className="flex-row flex">
      ...
      <div className="flex-col flex bg-nafl-grey-700 w-[500px] rounded-3xl overflow-hidden">
        ...
        <div className="bg-[#02B1B1] h-50 pb-1 px-4 flex-row flex justify-between">
