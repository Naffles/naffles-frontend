        ...
        <div className="relative bg-nafl-white rounded-xl mx-auto px-0 py-0 pb-7 h-[292px]">
          ...
          <div className="flex justify-between relative top-[-70px] bg-nafl-white">
            <div className="h-12 flex-row ml-2 mt-3">
              <h3 className="text-lg font-semibold text-nafl-charcoal-500">
                {title}
              </h3>
              <h4 className="text-lg text-nafl-charcoal-500">{description}</h4>
            </div>
            <div className="flex mt-2">
              <Typography size="text-5xl pr-2" color="accent-green">
                #9419
              </Typography>
            </div>
          </div>
          ...
          <div className="flex justify-between relative top-[-72px] pb-2">
            <div className="h-12 flex-row ml-2 mt-1">
              <h4 className="text-sm font-semibold text-nafl-charcoal-500">
                tickets left
              </h4>
              <h2 className="text-xl font-semibold text-nafl-charcoal-500">
                69
              </h2>
              <h4 className="text-xs font-semibold text-nafl-charcoal-500">
                of 23,000
              </h4>
            </div>
            <div className="flex-row mt-1 mr-2">
              <h4 className="text-sm font-semibold text-nafl-charcoal-500 text-right">
                ticket price
              </h4>
              <div className="flex">
                <Image
                ...
                />
                <h2 className="text-xl font-semibold text-nafl-charcoal-500 text-right">
                  0.01
                </h2>
              </div>
              <Typography
