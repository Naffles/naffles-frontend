...
const LeaderboardRafflersTable = () => {
  ...
  return (
    <div className="w-full px-[20px] bg-[#383838] mb-[50px] mt-[80px] min-h-[800px]">
      <Table
            ...
            <TableRow key={item.id}>
              ...
              <TableCell>
                <div className="flex flex-row items-center">
                  <p className="text-[16px] text-[#fff] font-bold">
                    {item.ticketsBought.toLocaleString()}
                  </p>
                </div>
              </TableCell>
              <TableCell>
...
export default LeaderboardRafflersTable;
